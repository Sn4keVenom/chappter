...
export interface UserSummary {
   ...
   * point system." RosterPage.tsx's Squad column reads this — Team is the
   * one concept (Gear Cup gamification groupings), not a second,
   * independent label. */
  teamId?: string | null;
  teamName?: string | null;
  /** "Maybe instead of pledge class in the roster, it should be
   * committee." — added alongside pledgeClassLabel rather than replacing
   * it. A member can belong to more than one committee at once. */
